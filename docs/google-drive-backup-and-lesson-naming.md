...
- **Security Boundary**: Grants access **ONLY** to files and folders opened or created by the Gemini AI Classroom Assistant application. The app cannot view, modify, list, or delete the user's personal documents, photos, or existing Google Drive files.
